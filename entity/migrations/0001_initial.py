# Generated by Django 2.0.3 on 2018-06-16 23:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('content_type', models.ForeignKey(limit_choices_to={'app_label': 'entity'}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('companies', models.ManyToManyField(blank=True, to='entity.Company', verbose_name='companies')),
            ],
            options={
                'verbose_name': 'group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('company', models.ManyToManyField(blank=True, to='entity.Company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('content_type', models.ForeignKey(limit_choices_to={'app_label': 'entity'}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('location', models.ForeignKey(limit_choices_to={'is_street_address': False}, on_delete=django.db.models.deletion.CASCADE, to='entity.Location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(limit_choices_to={'is_phone': False}, on_delete=django.db.models.deletion.CASCADE, to='entity.Location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('content_type', models.ForeignKey(limit_choices_to={'app_label': 'entity'}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('location', models.ForeignKey(limit_choices_to={'is_phone': False, 'is_street_address': False}, on_delete=django.db.models.deletion.CASCADE, to='entity.Location')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(limit_choices_to={'is_phone': False, 'is_street_address': False}, on_delete=django.db.models.deletion.CASCADE, to='entity.Location'),
        ),
        migrations.AddField(
            model_name='group',
            name='people',
            field=models.ManyToManyField(blank=True, to='entity.Person', verbose_name='people'),
        ),
        migrations.AddField(
