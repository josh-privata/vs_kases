...
from entity.forms import PersonCreateForm, PersonUpdateForm


def list(request, page=1, template='entity/person/list.html'):
...
def detail(request, pk, slug=None, template='entity/person/detail.html'):
    """Detail of a person.
...
def create(request, template='entity/person/create.html'):
    """Create a person.
...
def update(request, pk, slug=None, template='entity/person/update.html'):
    """Update a person.
...
def delete(request, pk, slug=None, template='entity/person/delete.html'):
    """Delete a company.
