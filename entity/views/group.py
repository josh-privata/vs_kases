...
from entity.models import Group
from entity.forms import GroupCreateForm, GroupUpdateForm


def list(request, page=1, template='entity/group/list.html'):
...
def detail(request, pk, slug=None, template='entity/group/detail.html'):
    """Detail of a group.
...
def create(request, template='entity/group/create.html'):
    """Create a group.
...
def update(request, pk, slug=None, template='entity/group/update.html'):
    """Update a group.
...
def delete(request, pk, slug=None, template='entity/group/delete.html'):
    """Update a group.
