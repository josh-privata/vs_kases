...
class UrlMixin(models.Model):
    ...
    def get_url(self):
        ...
        try:
            ...
            raise
        website_url = getattr(settings, "DEFAULT_WEBSITE_URL","http://127.0.0.1:8080")
...
class CreationModificationDateMixin(models.Model):
    ...
    date and time
    NEED TO IMPLEMENT
    auto_now_add and auto_now on the fields
    """
...
class MetaTagsMixin(models.Model):
    ...
    Use
    {{ idea.get_meta_tags }}
    can also render a specifc meta tag using the
